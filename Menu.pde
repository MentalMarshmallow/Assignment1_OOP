...
void Menu()
{
  ...
  text("This user interface allows you the visibility and easy access of your vitals and other important data. It will give you",gridWidth,gridHeight*3,gridWidth*8);
